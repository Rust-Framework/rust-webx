...
> **最新状态（2026-09-01）** — 架构迭代 Phase 0–4 已完成；框架版本已同步 rust-dix 0.7 / rust-ef 1.8.3 / rust-webx 0.3.7。下文「历史审查（2026-06-29）」保留作对照。
...
- rust-ef **1.8.3**、rust-dix **0.7**、rust-webx **0.3.7**（框架无 ORM 依赖）
