  ...
  function render(siteInfo) {
    ...
    document.getElementById("app").innerHTML = `
      <div class="page page-about">
        <div class="about-card layui-card">
          <div class="layui-card-body">
            ...
            <div class="about-links">
              ${links.github ? `<a class="layui-btn layui-btn-primary" href="${escapeHtml(links.github)}" target="_blank" rel="noopener">GitHub</a>` : ""}
              ${links.docs ? `<a class="layui-btn layui-btn-primary" href="${escapeHtml(links.docs)}" target="_blank" rel="noopener">文档</a>` : ""}
            </div>
          </div>
        </div>
      </div>`;
