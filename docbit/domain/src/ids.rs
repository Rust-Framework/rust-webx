...
pub mod seed {
    ...
    pub const CAT_DI: &str = "00000000-0000-4000-8000-000000000006";
    pub const CAT_AGENT: &str = "00000000-0000-4000-8000-000000000007";
    pub const CAT_UI: &str = "00000000-0000-4000-8000-000000000008";
    pub const USER_ADMIN: &str = "00000000-0000-4000-8000-000000000010";
    pub const EXH_RUST_DIX: &str = "00000000-0000-4000-8000-000000000013";
    pub const EXH_RUST_EF: &str = "00000000-0000-4000-8000-000000000011";
    pub const EXH_WEBX: &str = "00000000-0000-4000-8000-000000000012";
    pub const EXH_RUST_AGENT: &str = "00000000-0000-4000-8000-000000000014";
    pub const EXH_RUST_GPUI_RML: &str = "00000000-0000-4000-8000-000000000015";
    pub const EXH_RUST_AGENT_FLOW: &str = "00000000-0000-4000-8000-000000000016";
